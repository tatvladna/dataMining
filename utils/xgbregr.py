...
model_name = "XGBRegr"
output_folder = "../4-trees/xgbregr"
model=XGBRegressor()

# можно попробовать параметр 'boosting_type': ['gbtree', 'gblinear']
# но в gblinear нельзя использовать деревья :)
...
txt_path = os.path.join(output_folder, 'xgbregr.txt')
csv_path = os.path.join(output_folder, 'xgbregr.csv')
